...
namespace Kontur.Tests.Options.Conversion.Linq.Boxed.SelectMany.Options4
{
    [TestFixture]
    internal class None_Should
    {
        ...
        private static readonly IEnumerable<TestCaseData> Cases = SelectCasesGenerator.Create(4).ToTestCases(None);
